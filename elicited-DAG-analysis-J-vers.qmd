...
Good paper on projections and presevation of causal quantities under them: https://www-sciencedirect-com.ezproxy.lib.uts.edu.au/science/article/pii/S0888613X24000951 
...
dend_M23467 <- L012_hclust_M23467 |> 
    as.dendrogram() |> 
    set("by_labels_branches_lty",
        value = lab[is_D], TF_values = c(2,1)) 
...
L_hclust_perfect_learn_M23467 <- hclust(
    as.dist(
        d_mat[cp8(c(2,3,4,6,7)), cp8(c(2,3,4,6,7))]), 
    method = "complete")
...
Tanglegrams of the large cluster: 

``` {r}
tanglegram(dend1 = as.dendrogram(L_hclust_perfect_learn_M23467),
           dend2 = dend_M23467,
           main_left = "Target learning", main_right = "L-Consistency",
           sort = TRUE, edge.lwd = 3, lwd = 2,
           common_subtrees_color_lines = TRUE, 
