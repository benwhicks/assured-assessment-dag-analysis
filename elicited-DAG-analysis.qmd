...
plotting_Ln_between_distances <- function(D, D_sym = NULL,
                                      Level = "L1") {
    if (is.null(D_sym)) {
        D_sym <- (D + t(D)) / 2
    }
...
L2_between_model_metrics <- 
    compute_dist_matrix(tcdags_node_group, L2_dist, symmetric = TRUE)
...
L2_between_model_metrics_full <- 
    compute_dist_matrix(all.cluster.dags, L2_dist, symmetric = TRUE)
